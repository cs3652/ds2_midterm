...
scatterplot <- featurePlot(x, y, plot = "scatter", labels = c("","Y"),
            type = c("p"), layout = c(4, 2))

ggsave("scatterplot.jpeg", plot = last_plot(), device = "jpeg")
```
...
#The ridge regression was run both with and without standardizing predictors. In doing so we were better able to discern the relative importance of each predictor and ensure that their is equal contribution from each of the predictors. 
